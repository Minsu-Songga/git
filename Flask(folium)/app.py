...
def connectsql():
    conn = pymysql.connect(host='3.37.87.224', 
                           user = 'mstpjt', 
                           passwd = '1111', 
                           db = 'mstDB',
                           port = 58994, 
...
def index():
    if 'username' in session:
        ...
        return render_template('home.html', logininfo = username)
    else:
        username = None
...
# @app.route("/MAP", methods=["GET"])
# def MAP():
#     return render_template('opencv.html', image_file="static/images/5flow-1.jpg")
...
if __name__ == "__main__": 
    # app.run(host="192.168.0.221",port = 5555, debug=True)
